...
def upcoming_events_view(request):
    ...
    # Pull the raw list of child IDs
    child_ids = list(user.child_accounts.values_list("id", flat=True))

    # Query for all future event registrations in the household
    ...
    # Separate into distinct lists for clean template iteration
...
def outstanding_balance_view(request):
    ...
    total_balance_cents = totals["total_cents"] or 0
